    ...
    <section id="contact" className="relative z-10 flex min-h-screen items-center px-6 py-32">
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          ...
          {/* FIX: ambos os botões com h-[52px] + inline-flex + items-center para altura exatamente igual */}
          <div className="mt-12 flex flex-wrap gap-4">
            <a
              href="mailto:contato@defsoulstudio.com"
              className="inline-flex h-[52px] items-center rounded-full border border-white/10 bg-white px-7 text-xs uppercase tracking-[0.3em] text-black transition hover:bg-white/80"
            >
              Enviar sinal
            </a>
            ...
            <a
              ...
              className="inline-flex h-[52px] items-center rounded-full border border-white/10 bg-white/[0.03] px-7 text-xs uppercase tracking-[0.3em] text-white/60 backdrop-blur-xl transition hover:text-white"
            >
              WhatsApp
            </a>
          </div>
