    ...
    >
      ...
      <div className="mt-24 grid gap-6 md:grid-cols-2">
        {modules.map((module, index) => {
          const isShaderWorld =
            module.title === 'Shader Worlds'

          const isAI =
            module.title === 'AI Interfaces'
                ...
                {isShaderWorld && (
                  <>
                    <motion.div
                      ...
                      className="absolute left-1/2 top-1/2 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-violet-200/10"
                    />
                    ...
                    <motion.div
                      ...
                      className="absolute left-1/2 top-1/2 h-[180px] w-[180px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-violet-300/10 blur-3xl"
                    />
                  </>
                )}
